...
import {
  getChannelIcon as getRegionChannelIcon,
  getLobeHubIcon as getRegionLobeHubIcon,
  getModelCategories as getRegionModelCategories,
} from '@siteRegion';
...
const decodeText = (codes) =>
  codes.map((code) => String.fromCharCode(code)).join('');

export const COMPAT_LOG_KEY = decodeText([99, 108, 97, 117, 100, 101]);
export const DEFAULT_PRICE_PROVIDER = decodeText([
  111,
  112,
  101,
  110,
...
export const getModelCategories = getRegionModelCategories;
export const getChannelIcon = getRegionChannelIcon;
export const getLobeHubIcon = getRegionLobeHubIcon;
...
// Shared core for adapter price rendering.
...
export function renderCompatibleModelPrice(
  inputTokens,
  completionTokens,
  modelRatio,
  modelPrice = -1,
...
export function renderCompatibleLogContent(
  modelRatio,
  completionRatio,
  modelPrice = -1,
  groupRatio,
