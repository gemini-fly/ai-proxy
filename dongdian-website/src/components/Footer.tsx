        ...
        <div className={styles.top}>
          <div>
            <div className={styles.brand}>
              <img className={styles.brandIcon} src="/assets/brand/shanyu-logo-final.png" alt="" />
              <span className="gradient-text">闪域科技</span>
            </div>
            <p className={styles.brandDesc}>
              北京闪域科技有限公司专注于企业级 AI 服务，提供稳定、安全、经济的 Token 代理与 GPT 代充解决方案，让每家企业都能轻松接入 AI 时代。
            </p>
            <p className={styles.icp}>
              © {year} 北京闪域科技有限公司 · 京ICP备XXXXXXXX号
            </p>
          </div>
          ...
          <div className={styles.col}>
            ...
            <ul>
              ...
              <li><a href="https://www.shanview.cn" target="_blank" rel="noreferrer">官方网站</a></li>
            </ul>
          </div>
        </div>
